		  ...
		  try {
			  ...
			  Class.forName("com.mysql.jdbc.Driver");
				Connection conn = DriverManager.getConnection(
						"jdbc:mysql://localhost/attractions?useUnicode=true&characterEncoding=utf-8",prop);
				String sql ="INSERT INTO `tourism`(`Gid`, `Name`, `Zone`, `Toldescribe`, `Description`, `Tel`, `Add`, `Zipcode`, `Travellinginfo`, `Opentime`, `Picture1`, `Picdescribe1`, `Picture2`, `Picdescribe2`, `Picture3`, `Picdescribe3`, `Map`, `Gov`, `Px`, `Py`, `Orgclass`, `Class1`, `Class2`, `Class3`, `Level`, `Website`, `Parkinginfo`, `Parkinginfo_px`, `Parkinginfo_py`, `Ticketinfo`, `Remarks`, `Keyword`, `Changetime`)"
						+ "VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
			  ...
			  File fXmlFile = new File("C:\\Users\\master\\Downloads\\a.xml");
